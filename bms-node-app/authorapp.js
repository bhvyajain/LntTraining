...
manager.addAuthor(
  new Author("vivek", "Vivek Dutta Mishra", "Author of the Lost Epic Series")
);
manager.addAuthor(
  new Author(
    "archer",
    "Jeffrey Archer",
    "International best seller of fictions"
  )
);
manager.addAuthor(
  new Author("grisham", "John Grisham", "Leading author of legal fiction")
);
...
// showAuthors(manager.seracfun("vivek"), "serch by name");
manager.seracfun("fiction");
